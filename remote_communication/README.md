...
### 1. Communication Bridge Configuration (MAVLink over ELRS)
...
**1.1. ArduCopter Drone MAVLink Settings:** Setup Drone Parameters to accept Mavlink protocol
...
**1.2. Remote Controller ExpressLRS (ELRS) Firmware Settings:** Update the ELRS Lua script on your Radiomaster controller.
...
**1.3. Setup connection between Computer and Remote Controller:** Connect Computer to Remote Controller using UDP.
...
**1.4. Control the Drone from Computer:** You can control the drone using Mission Planner (QGroundControl) or a Python Script.
